...
export const DEMO_EPISODES: EpisodeRecord[] = [
  ...
  },
  {
    ...
    pain_qualities: ["icicles", "burning", "throbbing"],
    pain_quality_other: null,
    had_numbness: "yes",
    throbbing_associations: ["headache", "visual_disturbances"],
  ...
  },
  {
    ...
    pain_qualities: ["electrical", "other"],
    pain_quality_other: "Pressure behind the ear",
    had_numbness: "no",
    throbbing_associations: [],
    pain_pattern: "episodic_pulsing",
